...
Este é o build da página que contém os assets que foram gerados pelo esqueleto que usa o [Hugo](https://gohugo.io/). Este esqueleto está em: [https://github.com/atmosmps/personal-website](https://github.com/atmosmps/personal-website), e é o responsável por gerar novas atualizações.
